<?php 
	require 'Port/Place.php';
	session_start();
	$b1 = new Bateau("Mobidick",1.2,"ZODIAC","Downald Trump");
	$place[0] = new Place("000001",120,5,$b1);
	$place[1] = new Place("000002",500,30,$b1);
	$place[2] = new Place("000005",200,20);
?>
<!doctype HTML>
		<html>
			<head>
			...
			<body>	
					<div id='div_principale_tableau_de_bord'>
						...
						?>
						<center><h2>Liste des places</h2></center>
						<?php
							echo "<p id =nombre_bateaux>Vous avez ".count($_SESSION['liste_bateaux'])." bateau(x).</p>";
							echo "<p>ATTENTION PLACE EN DUR DANS LE CODE</p>";
